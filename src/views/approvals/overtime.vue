    ...
    <div class="contLeft">
      <div class="topTit">
        ...
        <div class="info">
          ...
          <p>
            <span>入职时间： {{ information.timeOfEntry | timeFormat }}</span>
          </p>
        </div>
      </div>
      <div class="content">
        ...
        <p>
          <span>加班开始时间：</span>
          {{ information.data.start_time | timeFormat }}
        </p>
        <p>
          <span>加班结束时间：</span>
          {{ information.data.end_time | timeFormat }}
        </p>
        <p>
          <span>申请原因：</span>
      ...
      <div class="Items">
        <li v-for="(item, index) in taskInstanceOutList" :key="index">
          <div
            ...
            "
          >
            <p>{{ item.handleTime | timeFormat }}</p>
