    ...
    <div class="contLeft">
      <div class="topTit">
        ...
        <div class="info">
          ...
          <p class="time">入职时间:  {{ user.timeOfEntry | timeFormat }}   最新工资： {{ formLabelAlign.currentPostWage + formLabelAlign.currentBasicSalary }} <ul><span class="more">?</span><li>员工所有调薪后的基本工资、岗位工资合计</li></ul></p>
